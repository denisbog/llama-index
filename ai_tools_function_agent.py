...
class SimpleFunctionAgent(BaseWorkflowAgent):
    ...
    async def take_step(
        ...
        only_tool_outputs = [a for a in scratchpad if a.role == "user"]
        current_llm_input = [*llm_input, *only_tool_outputs]
        ...
        last_chat_response = await self.llm.achat_with_tools(  # type: ignore
            tools=tools,
